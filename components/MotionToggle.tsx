...
export default function MotionToggle() {
  ...
  return (
    <button
      ...
      onClick={toggle}
      aria-pressed={off}
      className="inline-flex min-h-11 items-center gap-2 border border-ink/15 px-4 py-2 font-mono text-[0.62rem] tracking-[0.16em] text-ink-faint uppercase transition-colors hover:border-ink/35 hover:text-ink-muted"
    >
